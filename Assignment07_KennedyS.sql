...
-- 2017-01-01,KennedyS,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_KennedyS')
	 Begin 
	  Alter Database [Assignment07DB_KennedyS] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_KennedyS;
	 End
	Create Database Assignment07DB_KennedyS;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_KennedyS;
